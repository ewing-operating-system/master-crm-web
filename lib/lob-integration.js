...
async function handleLobWebhook(req, res) {
  ...
  try {
    ...
    // 2. Cost logging — handled at send time in batch-send.js / send.js.
    //    NOT logged here on webhook to prevent double-count.
    //    (Previous implementation inserted into cost_ledger on letter.mailed,
    //     but send.js already logs $1.75 at send time.)
